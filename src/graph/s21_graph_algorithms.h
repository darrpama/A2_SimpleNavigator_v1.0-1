...
class GraphAlgorithms {
 public:
  ...
  static TravelingSalesman::TsmResult SolveTravelingSalesmanProblem(
      const Graph& graph);
  static TravelingSalesman::TsmResult SolveTravelingSalesmanProblemGenetic(
      const Graph& graph);
  static TravelingSalesman::TsmResult
  SolveTravelingSalesmanProblemBranchesAndBounds(const Graph& graph);

 private:
  static void CheckVertex(const Graph& graph, int vertex,
